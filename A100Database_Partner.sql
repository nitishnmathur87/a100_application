...
CREATE TABLE `Partner` (
  ...
  `unix_linux` tinyint(1) NOT NULL,
  `sql` tinyint(1) DEFAULT NULL,
  `git` tinyint(1) DEFAULT '0',
  `wordpress` tinyint(1) DEFAULT '0',
  `drupal` tinyint(1) DEFAULT '0',
  `python` tinyint(1) DEFAULT '0',
  `svn` tinyint(1) DEFAULT '0',
  `objective_c` tinyint(1) DEFAULT '0',
  `ruby_rails` tinyint(1) DEFAULT '0',
  `c_plusplus` tinyint(1) DEFAULT '0',
  `dot_net` tinyint(1) DEFAULT '0',
  `php` tinyint(1) DEFAULT '0',
  `html_css` tinyint(1) DEFAULT '0',
