...
DROP TABLE IF EXISTS `supporting_materials`;
...
CREATE TABLE `supporting_materials` (
  ...
  KEY `apprentice_id_idx` (`apprentice_id`),
  CONSTRAINT `apprentice_id` FOREIGN KEY (`apprentice_id`) REFERENCES `apprentice` (`apprentice_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `supporting_materials` WRITE;
/*!40000 ALTER TABLE `supporting_materials` DISABLE KEYS */;
/*!40000 ALTER TABLE `supporting_materials` ENABLE KEYS */;
UNLOCK TABLES;
