...
DROP TABLE IF EXISTS `application_stack`;
...
LOCK TABLES `application_stack` WRITE;
/*!40000 ALTER TABLE `application_stack` DISABLE KEYS */;
INSERT INTO `application_stack` VALUES (1,'Linux',NULL),(2,'Apache',NULL),(3,'MySql',NULL),(4,'PHP',NULL);
/*!40000 ALTER TABLE `application_stack` ENABLE KEYS */;
UNLOCK TABLES;
