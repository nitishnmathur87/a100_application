...
CREATE TABLE `apprentice` (
  ...
  `a_support_id` int(11) DEFAULT NULL,
  ...
  KEY `technic_id_idx` (`technic_id`),
  KEY `a_support_id_idx` (`a_support_id`),
  KEY `institution_id_idx` (`institution_id`),
  KEY `state_id_idx` (`state_id`),
  KEY `schedule_id_idx` (`schedule_id`),
  CONSTRAINT `schedule_id` FOREIGN KEY (`schedule_id`) REFERENCES `schedule` (`schedule_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `a_support_id` FOREIGN KEY (`a_support_id`) REFERENCES `supporting_materials` (`support_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `apprentice` VALUES (1,'pinxia ','li','pinch123us@yahoo,com','123456','CS','2015-01-20','644 Prospect Street','New Haven','CT','06511','(203)-479-2998','N/A','N/A','1','Yes','20 hours ','2014-07-10',NULL,'Yes','N/A',1,1,1,0,NULL,NULL,NULL),(2,'Nitish','Mathur','mathur.nitish@gmail.com','123456','CS','2014-07-10','',NULL,NULL,NULL,'(###)###-###','2','N/A','Yes','Yes','Monday: 5:30-8:30pm; Wednesday: 5:30-8:30pm; Friday: 3-5pm','2014-07-10',NULL,'Yes','N/A',2,3,2,0,NULL,NULL,NULL),(3,'Timith','Smith','smithtim108@gmail.com','111111','CS','2014-07-10','211 Willow','New Haven','CT','06511','(203)123-1234','N/A','N/A','Yes','Yes','Available','2014-07-10',NULL,'Yes','N/A',2,2,2,0,NULL,NULL,NULL);
