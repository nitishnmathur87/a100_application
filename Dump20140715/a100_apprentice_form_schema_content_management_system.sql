...
DROP TABLE IF EXISTS `content_management_system`;
...
LOCK TABLES `content_management_system` WRITE;
/*!40000 ALTER TABLE `content_management_system` DISABLE KEYS */;
INSERT INTO `content_management_system` VALUES (1,'Drupal',NULL),(2,'Joomla',NULL),(3,'WordPress',NULL),(4,'etc',NULL);
/*!40000 ALTER TABLE `content_management_system` ENABLE KEYS */;
UNLOCK TABLES;
