...
CREATE TABLE `mobile_app_develop` (
  ...
  KEY `experiene_id_idx` (`experience_id`),
  CONSTRAINT `experiene_id` FOREIGN KEY (`experience_id`) REFERENCES `experience_level` (`experience_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `mobile_app_develop` VALUES (1,'Andoid',NULL),(2,'IOS',NULL),(3,'Windows Mobile',NULL);
