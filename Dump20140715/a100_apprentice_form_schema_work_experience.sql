...
INSERT INTO `work_experience` VALUES (1,'None'),(2,'At least one full-time job in an office setting'),(3,'At least one part-time job in an office setting'),(4,'At least one part-time job of any other kind (retail, Starbucks, construction, etc.)');
