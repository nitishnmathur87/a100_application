...
<body>
	...
	<h1 class="col-md-12">
			...
			<fieldset class="col-sm-12 well">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<select class="form-control" name="cohort" id="cohort" value="<?php echo $cohort="" ?>">
							...
							<option value="1">Cohort 2: Spring (Summer Internships)</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<select class="form-control" name="university_name" id="cohort" value="<?php echo $university_name="" ?>">
							<option selected>Please chose your university</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 control-group">
						<!--<textarea class="form-control" id="address" rows="3" placeholder="Enter your address here"></textarea>-->
					<!--<select class="form-control" name="path_to_a100[]" multiple>
						<option selected>Please select how did you get to know about the A100 program? Hold down ctrl to select multiple</option>
		...
		<form class="form-horizontal" role="form" method="POST" action="schedule_validation.php" id="schedule">
		...
		<form class="form-horizontal" role="form" method="POST" id="support">
			<fieldset class="col-sm-12 well">
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-9">
						<button type="submit" class="btn btn-primary">Save</button>
						<?php unset($_SESSION['support']); ?>
					</div>
				</div>
			</fieldset>
		</form>
		<form class="form-horizontal" role="form" action="complete_validation.php" method="POST" id="complete">
			<div class="form-group">
				<div style="text-align:center;">
					<button type="submit" class="btn btn-primary">Submit the Form</button>
					<?php unset($_SESSION['submit']); ?><br /><br />
				</div>
			</div>
		</form>
