...
<html>
    <head>
        ...
        <title>Retrieve and Update Apprentice Information</title>
        <link href="css/bootstrap.min.css" rel="stylesheet">
        <link href="css/main.css" rel="stylesheet">
        <link href='css/form.css' rel='stylesheet'>
    </head>
    <body>
        <h3 class="centered alert-info">Retrieve and Update Apprentice Information</h3>
        <div class="display container-fluid table-responsive" id="display">
            <?php
